...
namespace Doctrator\Extension\ActiveRecord;
 ...
 */
class DoctratorActiveRecordExtension extends Extension
{
    /**
     * @inheritdoc
     */
    ...
    {
        $this->processTemplate($this->definitions['entity_base'], 'activeRecord.php');
    }
}

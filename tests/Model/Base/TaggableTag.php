...
/**
 * Base class of the Model\TaggableTag entity.
 */
abstract class TaggableTag implements \ArrayAccess
{
    protected $id;
    ...
    {
        return $this->getEntityManager()->getRepository('Model\TaggableTag');
    }
    ...
    static public function loadMetadata(\Doctrine\ORM\Mapping\ClassMetadata $metadata)
    {
        ...
        $metadata->setCustomRepositoryClass('Model\TaggableTagRepository');

...
/**
 * Base class of the Model\TaggableTagging entity.
 */
abstract class TaggableTagging implements \ArrayAccess
{
    protected $id;
    ...
    /**
     * Set the parent_id column value.
     *
     * @param mixed $value The column value.
     */
    ...
    /**
     * Returns the parent_id column value.
     *
     * @return mixed The column value.
     */
    ...
    /**
     * Returns the tag_id column value.
     *
     * @return mixed The column value.
     */
    ...
    /**
     * Returns the parent relation value.
     *
    ...
    /**
     * Returns the tag relation value.
     *
     * @return mixed The relation value.
     */
    ...
    public function toArray()
    {
        ...
        $array['id'] = $this->getId();
        $array['parent_id'] = $this->getParentId();
        $array['tag_id'] = $this->getTagId();
    ...
    {
        return $this->getEntityManager()->getRepository('Model\TaggableTagging');
    }
    ...
    static public function loadMetadata(\Doctrine\ORM\Mapping\ClassMetadata $metadata)
    {
        ...
        $metadata->setCustomRepositoryClass('Model\TaggableTaggingRepository');
        ...
        $metadata->mapManyToOne(array(
            'fieldName' => 'tag',
            'targetEntity' => 'Model\\TaggableTag',
            'cascade' => array(
                0 => 'persist',
                1 => 'remove',
            ),
        ));
        $metadata->table['uniqueConstraints']['0'] = array(
            'columns' => array(
                0 => 'parent_id',
                1 => 'tag_id',
            ),

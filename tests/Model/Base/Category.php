...
/**
 * Base class of the Model\Category entity.
 */
abstract class Category implements \ArrayAccess
{
    protected $id;
    ...
    /**
     * Set the articles relation value.
     *
    ...
    /**
     * Returns the articles relation value.
     *
    ...
    {
        return $this->getEntityManager()->getRepository('Model\Category');
    }
    ...
    static public function loadMetadata(\Doctrine\ORM\Mapping\ClassMetadata $metadata)
    {
        ...
        $metadata->setCustomRepositoryClass('Model\CategoryRepository');

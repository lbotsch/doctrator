...
/**
 * Base class of the Model\Ipable entity.
 */
abstract class Ipable implements \ArrayAccess
{
    protected $id;
    ...
    {
        $this->setCreatedFrom(call_user_func(array('\Doctrator\Behavior\Ipable', 'getIp')));
    }

    public function updateTimestampableUpdated()
    {
        $this->setUpdatedFrom(call_user_func(array('\Doctrator\Behavior\Ipable', 'getIp')));
    }
    ...
    /**
     * Set the created_from column value.
     *
     * @param mixed $value The column value.
     */
    public function setCreatedFrom($value)
    {
        $this->created_from = $value;
    }

    /**
     * Returns the created_from column value.
     *
     * @return mixed The column value.
     */
    ...
    /**
     * Set the updated_from column value.
     *
     * @param mixed $value The column value.
     */
    public function setUpdatedFrom($value)
    {
        $this->updated_from = $value;
    }

    /**
     * Returns the updated_from column value.
     *
     * @return mixed The column value.
     */
    ...
    public function set($name, $value)
    {
        ...
        if ('created_from' == $name) {
            return $this->setCreatedFrom($value);
        }
        if ('updated_from' == $name) {
            return $this->setUpdatedFrom($value);
        }
    ...
    public function fromArray($array)
    {
        ...
        if (isset($array['created_from'])) {
            $this->setCreatedFrom($array['created_from']);
        }
        if (isset($array['updated_from'])) {
            $this->setUpdatedFrom($array['updated_from']);
        }
    }
    ...
    public function toArray()
    {
        ...
        $array['created_from'] = $this->getCreatedFrom();
        $array['updated_from'] = $this->getUpdatedFrom();
    ...
    {
        return $this->getEntityManager()->getRepository('Model\Ipable');
    }
    ...
    static public function loadMetadata(\Doctrine\ORM\Mapping\ClassMetadata $metadata)
    {
        ...
        $metadata->setCustomRepositoryClass('Model\IpableRepository');

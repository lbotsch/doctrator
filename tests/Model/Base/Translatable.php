...
/**
 * Base class of the Model\Translatable entity.
 */
abstract class Translatable implements \ArrayAccess
{
    protected $id;
     ...
     *
     * @return \{Model\Translatable}Translation The translation entity.
     */
    public function translation($locale)
    {
        ...
        $translation = new \Model\TranslatableTranslation();
    ...
    /**
     * Set the translations relation value.
     *
    ...
    /**
     * Returns the translations relation value.
     *
    ...
    {
        return $this->getEntityManager()->getRepository('Model\Translatable');
    }
    ...
    static public function loadMetadata(\Doctrine\ORM\Mapping\ClassMetadata $metadata)
    {
        ...
        $metadata->setCustomRepositoryClass('Model\TranslatableRepository');
        ...
        $metadata->mapOneToMany(array(
            ...
            'targetEntity' => 'Model\\TranslatableTranslation',
            'cascade' => array(
                0 => 'persist',
                1 => 'remove',
            ),

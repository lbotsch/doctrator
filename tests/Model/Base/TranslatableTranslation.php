...
/**
 * Base class of the Model\TranslatableTranslation entity.
 */
abstract class TranslatableTranslation implements \ArrayAccess
{
    protected $id;
    ...
    {
        return $this->getEntityManager()->getRepository('Model\TranslatableTranslation');
    }
    ...
    static public function loadMetadata(\Doctrine\ORM\Mapping\ClassMetadata $metadata)
    {
        ...
        $metadata->setCustomRepositoryClass('Model\TranslatableTranslationRepository');
        ...
        $metadata->mapManyToOne(array(
            'fieldName' => 'parent',
            'targetEntity' => 'Model\\Translatable',
            'cascade' => array(
                0 => 'persist',
                1 => 'remove',
            ),

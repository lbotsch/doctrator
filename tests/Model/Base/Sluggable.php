...
/**
 * Base class of the Model\Sluggable entity.
 */
abstract class Sluggable implements \ArrayAccess
{
    protected $id;
    ...
    public function updateSluggableSlug()
    {
        ...
        $query = $this->getEntityManager()->createQuery("SELECT e.id, e.slug FROM Model\Sluggable e WHERE e.slug LIKE ?1");
    ...
    {
        return $this->getEntityManager()->getRepository('Model\Sluggable');
    }
    ...
    static public function loadMetadata(\Doctrine\ORM\Mapping\ClassMetadata $metadata)
    {
        ...
        $metadata->setCustomRepositoryClass('Model\SluggableRepository');

...
/**
 * Base class of the Model\IdentifierStrategyIdentity entity.
 */
abstract class IdentifierStrategyIdentity implements \ArrayAccess
{
    protected $id;
    ...
    {
        return $this->getEntityManager()->getRepository('Model\IdentifierStrategyIdentity');
    }
    ...
    static public function loadMetadata(\Doctrine\ORM\Mapping\ClassMetadata $metadata)
    {
        ...
        $metadata->setCustomRepositoryClass('Model\IdentifierStrategyIdentityRepository');

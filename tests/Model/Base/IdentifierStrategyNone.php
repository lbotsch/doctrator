...
/**
 * Base class of the Model\IdentifierStrategyNone entity.
 */
abstract class IdentifierStrategyNone implements \ArrayAccess
{
    protected $id;
    ...
    {
        return $this->getEntityManager()->getRepository('Model\IdentifierStrategyNone');
    }
    ...
    static public function loadMetadata(\Doctrine\ORM\Mapping\ClassMetadata $metadata)
    {
        ...
        $metadata->setCustomRepositoryClass('Model\IdentifierStrategyNoneRepository');
